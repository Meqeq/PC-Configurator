...
class MbdSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('mbd')->insert([
            ...
            'compatibility' => json_encode(['cpu'=>['socket'=>"AM4"], "ram"=>['type'=>'DDR4'], 'pccase'=>['type'=>'ATX'], 'drive'=>['type'=>['M2', 'SATA']]]),
            'price' => 419,
        ...
        DB::table('mbd')->insert([
            ...
            'compatibility' => json_encode(['cpu'=>['socket'=>"1200"], "ram"=>['type'=>'DDR4'], 'pccase'=>['type'=>'ATX'], 'drive'=>['type'=>['M2', 'SATA']]]),
            'price' => 419,
        ...
        DB::table('mbd')->insert([
            ...
            'compatibility' => json_encode(['cpu'=>['socket'=>"1151"], "ram"=>['type'=>'DDR4'], 'pccase'=>['type'=>['ATX', 'mATX']], 'drive'=>['type'=>['SATA']]]),
            'price' => 259,
            'img' => 'https://cdn.x-kom.pl/i/setup/images/prod/big/product-new-big,,2020/5/pr_2020_5_27_12_19_16_814_00.jpg'
        ]);
        ...
        DB::table('mbd')->insert([
            ...
            'compatibility' => json_encode(['cpu'=>['socket'=>"1151"], "ram"=>['type'=>'DDR4'], 'pccase'=>['type'=>'ATX'], 'drive'=>['type'=>['SATA']]]),
            'price' => 569,
