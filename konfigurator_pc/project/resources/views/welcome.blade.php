            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @endif
                    @endauth
                        <a href="{{ url('/pcconfigs') }}" class="ml-4 text-sm text-gray-700 underline">Browse</a>
                </div>
            @endif

            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="{{URL::asset('/img/desktop.png')}}" alt="Desktop" width="60" height="60">
                    <p class="font-mono text-7xl">PC CONFIGURATOR</p>
                </div>
...
{{--                    todo--}}
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        PC configurator v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </div>
                </div>
            </div>

            <a href="{{ url('/pcconfigs/create') }}" class="absolute bottom-0 right-0 m-20">
                <button
